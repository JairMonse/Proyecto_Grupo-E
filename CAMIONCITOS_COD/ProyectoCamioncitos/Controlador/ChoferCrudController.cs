...
namespace ProyectoCamioncitos.Controlador
{
    ...
    class ChoferCrudController
    {
        ...
        public void CargarChofer()
        {
            ...
            Vista.tblChofer.Columns["Celular"].Visible = true;
            Vista.tblChofer.Columns["Fecha"].Visible = true;
            Vista.tblChofer.Columns["Correo"].Visible = true;
            Vista.tblChofer.Columns["Direccion"].Visible = true;
        ...
        public void dgvChofer_SelectedRows(object sender, EventArgs e)
        {
            ...
            if (Vista.tblChofer.SelectedRows.Count > 0)
            {
                ...
                Vista.txtEdad.Text = ChoferR[0].Fecha.ToString();
